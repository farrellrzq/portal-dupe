    ...
    (n = function () {
      ...
      (s.sparkline_display_visible = function () {
        ...
        for (i = 0, e = j.length; i < e; i++)
          s((t = j[i][0])).is(":visible") && !s(t).parents().is(":hidden")
            ? (j[i][1].call(t), s.data(j[i][0], "_jqs_pending", !1), n.push(i))
        ...
        init: function (t, i) {
          ...
          (this.userOptions = i = i || {}),
            ...
            (this.tagOptionsPrefix =
              i.enableTagOptions && (i.tagOptionsPrefix || r.tagOptionsPrefix)),
            (e =
        ...
        getTagSetting: function (t) {
          ...
          if (this.tagValCache.hasOwnProperty(t)) i = this.tagValCache.key;
            ...
            if ((i = this.tag.getAttribute(a + t)) === e || null === i) i = L;
              ...
              for (s = (i = i.substr(1, i.length - 2).split(",")).length; s--; )
                i[s] = l(i[s].replace(/(^\s*)|(\s*$)/g, ""));
            else if ("{" === i.substr(0, 1))
              for (
                n = i.substr(1, i.length - 2).split(","), i = {}, s = n.length;
                s--;
      ...
      (s.fn.sparkline._base = r({
        ...
        setRegionHighlight: function (t, i, s) {
          ...
          return i > this.canvasWidth || s > this.canvasHeight || i < 0 || s < 0
            ? null
        ...
        r(s.fn.sparkline._base, {
          ...
          getRegion: function (t, i, s) {
            var n,
              r = this.regionMap;
            for (n = r.length; n--; )
              if (null !== r[n] && i >= r[n][0] && i <= r[n][1]) return r[n][2];
            return e;
          },
          getCurrentRegionFields: function () {
          ...
          render: function () {
            ...
            if (
              ...
              for (
                ...
                (p = k[H]),
                  ...
                  (m =
                    ...
                    ((f =
                      H < x - 1 ? h + i.round((c - this.minx) * (q / t)) : q) -
                      d) /
                      2),
                  (L[H] = [v || 0, m, H]),
                  (v = m),
                  null === u
                    ? H &&
                      (null !== M[H - 1] && ((l = []), g.push(l)), P.push(null))
              ...
              if (j && W.get("valueSpots"))
                for (
                  (R = W.get("valueSpots")).get === e && (R = new $(R)), H = 0;
                  H < x;
                  H++
                )
                  (S = R.get(M[H])) &&
