  ...
  var e = {
      ...
      8240: function (e, t, n) {
        ...
        function p(e, t, n) {
          ...
          return (
            (h || (!h && !n)) &&
              (("body" !== (0, o.Z)(t) || (0, c.Z)(g)) &&
                (b =
                  (p = t) !== (0, r.Z)(p) && (0, a.Re)(p)
      ...
      400: function (e, t, n) {
        ...
        function o(e, t, n) {
          ...
          t &&
            (0, i.Re)(e) &&
            ((l =
              (e.offsetWidth > 0 && (0, s.NM)(o.width) / e.offsetWidth) || 1),
            (d =
              (e.offsetHeight > 0 && (0, s.NM)(o.height) / e.offsetHeight) ||
              1));
      ...
      3779: function (e, t, n) {
        ...
        var l = n(5923),
          d = n(5918);
        function c(e) {
          return (0, a.Re)(e) && "fixed" !== (0, r.Z)(e).position
            ? e.offsetParent
            : null;
        }
        function u(e) {
                ...
                (function (e) {
                  ...
                  return (
                    "rtl" === (0, l.Z)(s || n).direction &&
                      (p +=
                        (0, c.Fp)(n.clientWidth, s ? s.clientWidth : 0) - o),
                    { width: o, height: u, x: p, y: f }
                  );
                })((0, r.Z)(e))
              );
        }
      ...
      9286: function (e, t, n) {
        e.exports = (function (e) {
          ...
          function p(e, n, i, s, r) {
            ...
            (y.delegationSelector = o ? i : null),
              (y.callable = p),
              (y.oneOff = r),
              (y.uidEvent = w),
              (m[w] = y),
              e.addEventListener(f, y, o);
          }
      ...
      744: function (e, t, n) {
        e.exports = (function (e, t, n) {
          ...
          class f extends a.default {
            ...
            deactivate() {
              this._isActive &&
                ((this._isActive = !1), s.default.off(document, o));
            }
            _handleFocusin(e) {
            ...
            return (
              (a.addListener = function (e) {
                t &&
                  ...
                  0 === l && (l = s.push({ mql: a, listeners: o })),
                  o.push(e));
              }),
    ...
    (function () {
        ...
        P = {
          loopCreate: function () {
            ...
            for (let e = o.length - 1; e >= 0; e -= 1)
              r.prepend(h(o[e].cloneNode(!0)).addClass(n.slideDuplicateClass));
          },
          loopFix: function () {
            const e = this;
      ...
      function Q({ swiper: e, extendParams: t, on: n, emit: i }) {
        ...
        function C(t) {
          ...
          o.touch
            ? (l[u](i.start, w, d), l[u](i.move, y, d), l[u](i.end, x, c))
            : (l[u](s.start, w, d), r[u](s.move, y, d), r[u](s.end, x, c));
        }
        function E() {
      ...
      function Pe() {
        ...
        e - ke < 20 &&
          ((_e.isTouch = !1), document.removeEventListener("mousemove", Pe)),
          (ke = e);
      }
      function Oe() {
        var e,
        ...
        var n = Object.assign(
          ...
          t.ignoreAttributes
            ...
            : (function (e, t) {
                return (
                  t
                    ? Object.keys(Ie(Object.assign({}, Le, { plugins: t })))
                    : $e
                ).reduce(function (t, n) {
      ...
      function Ne(e) {
        ...
        return (
          !0 === e
            ? (t.className = le)
            : ((t.className = de), xe(e) ? t.appendChild(e) : je(t, e)),
          t
        );
      }
      function ze(e, t) {
        ...
        function s(n, i) {
          ...
          i.theme
            ...
            i.arrow
              ? o
                ? n.arrow !== i.arrow &&
                  (r.removeChild(o), r.appendChild(Ne(i.arrow)))
                : r.appendChild(Ne(i.arrow))
              : o && r.removeChild(o);
        }
        return (
          (i.className = oe),
      ...
      function He(e, t) {
              ...
              if (!w.state.isDestroyed) {
                ...
                (w.props = i),
                  ...
                  n.interactiveDebounce !== i.interactiveDebounce &&
                    (j(), (g = me(W, i.interactiveDebounce))),
            ...
            show: function () {
              ...
              if (
                ...
                (o = function () {
                  ...
                  (d = A()),
                  (a =
                    (w.props.interactive && l === ue) || "parent" === l
                      ? d.parentNode
                      : he(l, [d])).contains(x) || a.appendChild(x),
                  (w.state.isMounted = !0),
                  K();
              }
            },
        ...
        function P() {
          var e,
            ...
            n = A().parentNode;
          return n
            ? null != (t = ge(n)[0]) && null != (e = t.ownerDocument) && e.body
              ? t.ownerDocument
              : document
            : document;
        }
        ...
        function M(e) {
          return (w.state.isMounted && !w.state.isVisible) ||
            ...
            (r && "focus" === r.type)
            ? 0
            : pe(w.props.delay, e ? 0 : 1, Le.delay);
        }
        function L(e) {
          void 0 === e && (e = !1),
        ...
        function V() {
          ...
          e.addEventListener("mousedown", N, !0),
            e.addEventListener("touchend", N, ce),
        ...
        function B() {
          ...
          e.removeEventListener("mousedown", N, !0),
            e.removeEventListener("touchend", N, ce),
      ...
      function Re(e, t) {
        ...
        document.addEventListener("touchstart", Ae, ce),
