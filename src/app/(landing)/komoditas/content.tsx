            ...
            .map((item: any, index: number) => {
                ...
                <div className="swiper-slide" key={index}>
                    ...
                    <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
                        ...
                        <a href="#">
                            <span className="font-display text-base text-jacarta-700 hover:text-green-600 dark:text-white">
                            {item.komoditi}
                            </span>
                        </a>
                        ...
                        <div className="w-1/2">
                            <div>
                            <span
                                className={`inline-block font-display text-lg font-semibold text-accent ${
                                parseFloat(item.price_yesterday) >
