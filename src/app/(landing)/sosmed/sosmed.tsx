...
export default async function sosmed() {
    return (
        <>
            <div className="lg:w-3/4 w-full grid grid-cols-1 p-8">
                ...
                >
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-instagram p-2 rounded-lg mx-auto mb-7 -mt-[3.5rem] h-[3rem] w-[3rem] border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700 text-[#ff8ba7] dark:fill-white"
                        viewBox="0 0 16 16"
                    >
                    ...
                    <p className="dark:text-jacarta-300">
                        Informasi Perangkat Daerah Kota Depok yang dipublikasikan melalui
                        instagram
                    </p>
                </a>
                                ...
                                <article>
                                    <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
                                        <figure>
                                            ...
                                            >
                                                <img
                                                    src="/img/infografis/instagram.jpg"
                                                    alt="item 1"
                                                    width="230"
                                                    height="230"
                                                    className="w-full h-[15rem] object-cover rounded-[0.625rem]"
                                                    loading="lazy"
                                                />
                                            </a>
                                        </figure>
                                        <div className="mt-4 flex items-center justify-between">
                                            <a href="#">
                                                <span className="font-display text-base text-jacarta-700 hover:text-yellow-600 dark:text-white">
                                                    Kelurahan Kalimulya saat ini telah memiliki
                                                </span>
                                            </a>
                                ...
                                <article>
                                    <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
                                        <figure>
                                            ...
                                            >
                                                <img
                                                    src="/img/infografis/instagram2.jpg"
                                                    alt="item 2"
                                                    width="230"
                                                    height="230"
                                                    className="w-full h-[15rem] object-cover rounded-[0.625rem]"
                                        ...
                                        <div className="mt-4 flex items-center justify-between">
                                            <a href="#">
                                                <span className="font-display text-base text-jacarta-700 hover:text-yellow-600 dark:text-white">
                                                    Gedung baru SDN Cisalak Pasar 1..
                                                </span>
                                            </a>
                                            <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
                                                <span className="text-sm font-medium tracking-tight text-green">
                                ...
                                <article>
                                    <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
                                        <figure>
                                            ...
                                            >
                                                <img
                                                    src="/img/infografis/instagram3.jpg"
                                                    alt="item 6"
                                                    width="230"
                                                    height="230"
                                                    className="w-full h-[15rem] object-cover rounded-[0.625rem]"
                                        ...
                                        <div className="mt-4 flex items-center justify-between">
                                            <a href="#">
                                                <span className="font-display text-base text-jacarta-700 hover:text-yellow-600 dark:text-white">
                                                    Sejumlah petugas gabungan yang terdiri
                                                </span>
                                            </a>
                                            <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
                                                <span className="text-sm font-medium tracking-tight text-green">
                                ...
                                <article>
                                    <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-[1.1875rem] transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
                                        <figure>
                                            ...
                                            >
                                                <img
                                                    src="/img/infografis/instagram4.jpg"
                                                    alt="item 4"
                                                    width="230"
                                                    height="230"
                                                    className="w-full h-[15rem] object-cover rounded-[0.625rem]"
                                        ...
                                        <div className="mt-4 flex items-center justify-between">
                                            <a href="#">
                                                <span className="font-display text-base text-jacarta-700 hover:text-yellow-600 dark:text-white">
                                                    Setiap tanggal 25 Januari diperingati
                                                </span>
                                            </a>
                                            <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
                                                <span className="text-sm font-medium tracking-tight text-green">
