                ...
                return (
                  <div
                    ...
                    {item.urlcontent === "" ? (
                      ...
                      <a href={item.urlcontent} target='_blank'>
                        <img
                          src={
                            item.lampiran
                              ? `https://cms.depok.go.id/upload/${item.lampiran}`
                  ...
                  {item.URLMenu === "" ? (
                    <a href={`layanan/layanan-kota/${item?.Id}`}>
                      <img
                        src={
                          item.ImageMenu
                            ? `https://cms.depok.go.id/upload/externalLogo/${
                                item.ImageMenu || <Skeleton />
                              }`
                            : "/img/kecamatan/dsw/kesehatan.png"
                        }
                      ...
                      />
                      <h3 className='font-display text-md text-jacarta-700 dark:text-white'>
                        {item.TitleMenu || <Skeleton />}
                      </h3>
                    </a>
                  ) : (
                    <a
                      data-bs-toggle='modal'
                      data-bs-target={`.video-lightbox-999`}
                      onClick={() => setIframeUrl(item.URLMenu)}
                ...
                <div className='modal-content'>
                  <div className=''>
                    <div className='modal-body'>
                      ...
                      <iframe src={cleanedURL} width='1000' height='600' title='Video Modal'></iframe>
                    </div>
                  </div>
                </div>
              </div>
