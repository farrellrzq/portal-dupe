        ...
        <div
            ...
            <div className="flex flex-wrap ">
                <div className="py-20 px-12 lg:w-[55%] lg:pl-16">
                    <div className="">
                        <h1 className="mb-3 font-display text-4xl font-semibold text-jacarta-700 dark:text-white">Tentang Kami</h1>

                        {/* 3. Gunakan variabel yang sudah aman */}
                        <p className="mb-10 text-sm dark:text-jacarta-300" style={{ textTransform: 'lowercase' }} dangerouslySetInnerHTML={{ __html: cleanProfileSite?.Description || 'Informasi tidak tersedia.' }}>
                        </p>
                        ...
                        <div className="flex space-x-5 mt-8">
                            {cleanProfileSite?.Facebook && (
                                <a
                                    href={cleanProfileSite.Facebook}
                                    target="_blank"
                            ...
                            {cleanProfileSite?.Instagram && (
                                <a
                                    href={cleanProfileSite.Instagram}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group"
                                >
