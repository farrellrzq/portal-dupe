...
export default async function ContentProfil() {
    ...
    // 3. Gunakan variabel yang sudah aman untuk memproses deskripsi
    const deskripsi = cleanProfileSite?.Description || 'Informasi tidak tersedia.';
            ...
            <div className="flex flex-wrap ">
                ...
                <div className="lg:w-[45%]">
                    <div className="relative">
                        <Image src="/img/about/GDPR-cuate.png" alt="Illustrasi tentang kami" className="absolute w-full top-0 animate-fly" width={500}
                            height={500} />
                    </div>
                </div>
            </div>
