...
export const metadata: Metadata = {
  title: 'Hubungi Kami',
  description: 'Hubungi Kami I Portal Dinsos Kota Depok',
};
        ...
        <div className="container">
          <div className="lg:flex">
            <div className="mb-12 lg:mb-0 lg:w-2/3 lg:pr-12">
              <h2 className="mb-4 font-display text-xl text-jacarta-700 dark:text-white">Kontak Kami - {profilSite?.Name ? profilSite.Name : "Dinsos Depok"}</h2>
              ...
              <div
                ...
                <div className="mb-6 flex items-center space-x-5">
                  ...
                  <div>
                    ...
                    <address className="text-sm not-italic dark:text-jacarta-300">{profilSite?.Alamat ?? "Dinsos Depok"}</address>
                  </div>
                </div>
