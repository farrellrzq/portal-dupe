...
export const metadata: Metadata = {
    title: 'Hubungi Kami',
    description: 'Hubungi Kami | Portal OPD Kota Depok',
};
                ...
                <div className="container">
                    <div className="lg:flex">
                        <div className="mb-12 lg:mb-0 lg:w-2/3 lg:pr-12">
                            ...
                            <h2 className="mb-4 font-display text-xl text-jacarta-700 dark:text-white">Kontak Kami - {cleanProfileSite?.Name ?? "OPD Depok"}</h2>
                            ...
                            <div
                                ...
                                <div className="mb-6 flex items-center space-x-5">
                                    ...
                                    <div>
                                        ...
                                        <address className="text-sm not-italic dark:text-jacarta-300">{cleanProfileSite?.Alamat ?? "OPD Depok"}</address>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-5">
                                    ...
                                    <div>
                                        ...
                                        >{cleanProfileSite?.Email ?? "diskominfo@depok.go.id"}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
