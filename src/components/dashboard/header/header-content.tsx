      ...
      <div className="js-mobile-menu invisible lg:visible fixed inset-0 z-10 ml-auto items-center bg-white dark:bg-jacarta-800 lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
        ...
        <div className="ml-8 hidden lg:flex xl:ml-24">
          ...
          <a href="#"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
              className="dark-mode-light h-4 w-4 fill-jacarta-700 transition-colors group-hover:fill-black group-focus:fill-black block dark:hidden">
              <path fill="none" d="M0 0h24v24H0z" />
              <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
              className="dark-mode-dark h-4 w-4 fill-jacarta-700 transition-colors group-hover:fill-white group-focus:fill-white hidden dark:block dark:fill-white">
              <path fill="none" d="M0 0h24v24H0z" />
              <path
