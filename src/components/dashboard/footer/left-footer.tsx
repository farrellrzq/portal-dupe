    ...
    <div className="col-span-full sm:col-span-3 md:col-span-4">
      ...
      <div>
        <p className="mb-2 dark:text-jacarta-300">
          {profileSite && profileSite.Description
            ? profileSite.Description.length > 165
              ? `${profileSite.Description.substring(0, 165)}...`
              : profileSite.Description
            : "Dinas Komunikasi dan Informatika | Pemerintah Kota Depok Portal Resmi Dinsos Kota Depok"}
        </p>
        {profileSite?.Description &&
          profileSite.Description.length > 165 && (
            <>
              ...
              {/* Replace "#" with the actual link you want to navigate to */}
            </>
          )}
      </div>
      {/* <!-- Socials --> */}
